...
from tax import amount_of_deferred_asset_to_sell
...
parameters = {
    ...
    "incomes": [{"person": "spouse", "start_year": 2023, "end_year": 2050, "amount": 6000, "index_rate": 0.04}],
...
transaction = Transaction('credit', 'spouse', Account.CLEARING, 177763, TransactionType.PENSION_INCOME, 0, 'OAS')
...
amount_of_deferred_asset_to_sell(parameters, 2033, transactions, 'spouse', 9700.593458569578, 87225.0, tax_rates)
